        ...
        <form @submit.prevent="addLocation()" class="flex">
            <div class="w-full mr-5">
                <div class='relative flex mt-2.5 first:mt-0'>
                    <svg :class="`absolute w-5 h-5 fill-text transition-[0.275s] left-2.5 top-2.5
                    ...
                    <input :class="` w-full h-10 text-text text-base transition-[0.275s] pl-10 px-2.5 py-[5px] rounded-[10px] focus:border focus:border-background-accept focus:border-solid
